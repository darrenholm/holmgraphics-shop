<!-- src/routes/shop/cart-legacy/+page.svelte
     LEGACY cart preserved during the decoration-builder release window.
     The active cart at /shop/cart is now the new visual builder
     (src/routes/shop/cart/+page.svelte). This route remains as a fallback
     for buyers in the middle of the old flow — remove after one release
     cycle once /shop/cart has been fully shaken out.
