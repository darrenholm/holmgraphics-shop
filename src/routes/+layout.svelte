...
<svelte:head>
  <!-- PWA / iOS web app tags. SEO + OG tags live in app.html because
       most routes export `ssr = false` which means the layout's
       svelte:head never makes it into the prerendered HTML. -->
  ...
  <div class="shell">
    ...
    <nav class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="/jobs/from-email" class:active={onPage('/jobs/from-email')}>
        ...
        <li>
          <a href="/schedule" class:active={onPage('/schedule')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Schedule
          </a>
        </li>
        <li>
          <a href="/inventory/media" class:active={onPage('/inventory/media') || onPage('/inventory')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 7h-7L9 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2Z"/><circle cx="12" cy="14" r="3"/></svg>
            Inventory
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="/fleet-admin" class:active={onPage('/fleet-admin') || onPage('/fleet-docs')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 17h4V5H2v12h3"/><path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5"/><path d="M14 17h1"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>
            Fleet
          </a>
        </li>
        <li>
	...
	<a href="/upload" class="nav-link">📷 Upload Photos</a>
        ...
        {#if $isAdmin}
        <li>
          <a href="/admin/timesheets" class:active={onPage('/admin/timesheets') && !onPage('/admin/timesheets/export')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Timesheets
          </a>
        </li>
        <li>
          <a href="/admin/pay-periods" class:active={onPage('/admin/pay-periods')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
            Pay Periods
          </a>
        </li>
        <li>
          <a href="/admin/staff" class:active={onPage('/admin/staff')}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Staff
          </a>
        </li>
    ...
    <nav class="mobile-nav">
      ...
      <a href="/time" class="mobile-nav-item" class:active={onPage('/time')}>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .staff-btn-sm { display: inline-flex; color: var(--text-muted); padding: 4px; margin-right: 2px; }
    .staff-btn-sm.active { color: var(--accent, #c0392b); }
